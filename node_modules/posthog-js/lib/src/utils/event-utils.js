...
exports.getBrowserDetectionHints = getBrowserDetectionHints;
...
exports.CAMPAIGN_PARAMS = __spreadArray([
    'utm_source',
    'utm_medium',
    'utm_campaign',
    'utm_content',
    ...
    'mc_cid'
], __read(exports.PERSONAL_DATA_CAMPAIGN_PARAMS), false);
...
function getCampaignParams(customTrackedParams, maskPersonalDataProperties, customPersonalDataProperties) {
    ...
    var paramsToMask = maskPersonalDataProperties
        ? __spreadArray(__spreadArray([], __read(exports.PERSONAL_DATA_CAMPAIGN_PARAMS), false), __read((customPersonalDataProperties || [])), false) : [];
...
function getBrowserDetectionHints() {
    ...
    return (nav === null || nav === void 0 ? void 0 : nav.brave) ? { brave: true } : {};
}
function getEventProperties(maskPersonalDataProperties, customPersonalDataProperties, detectGoogleSearchApp) {
    var _a, _b, _c;
    ...
    var paramsToMask = maskPersonalDataProperties
        ? __spreadArray(__spreadArray([], __read(exports.PERSONAL_DATA_CAMPAIGN_PARAMS), false), __read((customPersonalDataProperties || [])), false) : [];
    var _d = __read((0, core_2.detectOS)(globals_1.userAgent), 2), os_name = _d[0], os_version = _d[1];
    var browserHints = getBrowserDetectionHints();
    var browserOptions = { detectGoogleSearchApp: detectGoogleSearchApp };
    var properties = (0, index_1.extend)((0, index_1.stripEmptyProperties)({
        $os: os_name,
        $os_version: os_version,
        $browser: (0, core_2.detectBrowser)(globals_1.userAgent, navigator.vendor, browserHints, browserOptions),
        $device: (0, core_2.detectDevice)(globals_1.userAgent),
        $device_type: (0, core_2.detectDeviceType)(globals_1.userAgent, {
            // eslint-disable-next-line compat/compat
            userAgentDataPlatform: (_a = navigator === null || navigator === void 0 ? void 0 : navigator.userAgentData) === null || _a === void 0 ? void 0 : _a.platform,
            maxTouchPoints: navigator === null || navigator === void 0 ? void 0 : navigator.maxTouchPoints,
        ...
        $browser_version: (0, core_2.detectBrowserVersion)(globals_1.userAgent, navigator.vendor, browserHints, browserOptions),
    ...
    if (config_1.default.SDK_DIST_CHANNEL) {
        properties[constants_1.SDK_DIST_CHANNEL] = config_1.default.SDK_DIST_CHANNEL;
    }
    return properties;
}
