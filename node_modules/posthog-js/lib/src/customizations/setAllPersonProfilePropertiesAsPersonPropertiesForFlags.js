...
var setAllPersonProfilePropertiesAsPersonPropertiesForFlags = function (posthog) {
    var allProperties = (0, utils_1.extend)({}, (0, event_utils_1.getEventProperties)(posthog.config.mask_personal_data_properties, posthog.config.custom_personal_data_properties, posthog.config.detect_google_search_app), (0, event_utils_1.getCampaignParams)(posthog.config.custom_campaign_params, posthog.config.mask_personal_data_properties, posthog.config.custom_personal_data_properties), (0, event_utils_1.getReferrerInfo)());
