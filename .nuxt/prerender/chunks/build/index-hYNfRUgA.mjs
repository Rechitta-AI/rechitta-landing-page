import { defineComponent, ref, computed, toValue, reactive, watch, shallowRef, getCurrentInstance, provide, cloneVNode, h, createElementBlock, onServerPrefetch, nextTick, unref, toRef, useSSRContext } from 'file:///Users/mehul/Desktop/KAIZEN%20VENTURES/SENSEIBLES/PROJECTS/RECHITTA/rechitta-landing-page/node_modules/vue/index.mjs';
import { _ as _export_sfc, d as useRoute, e as useRuntimeConfig, f as fetchDefaults, s as sanitizeTag, u as useNuxtApp, b as asyncDataDefaults, c as createError } from './server.mjs';
import { ssrRenderAttrs, ssrRenderComponent } from 'file:///Users/mehul/Desktop/KAIZEN%20VENTURES/SENSEIBLES/PROJECTS/RECHITTA/rechitta-landing-page/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file:///Users/mehul/Desktop/KAIZEN%20VENTURES/SENSEIBLES/PROJECTS/RECHITTA/rechitta-landing-page/node_modules/ohash/dist/index.mjs';
import { isPlainObject } from 'file:///Users/mehul/Desktop/KAIZEN%20VENTURES/SENSEIBLES/PROJECTS/RECHITTA/rechitta-landing-page/node_modules/@vue/shared/dist/shared.cjs.prod.js';
import { debounce } from 'file:///Users/mehul/Desktop/KAIZEN%20VENTURES/SENSEIBLES/PROJECTS/RECHITTA/rechitta-landing-page/node_modules/perfect-debounce/dist/index.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const filmBase = config.public.filmBase;
    const { data: manifest } = useFetch(
      `${filmBase}/manifest.json`,
      { server: false },
      "$P3MfmMnThQ"
      /* nuxt-injected */
    );
    ...
    computed(() => reduced.value || route.query.storyboard !== void 0);
    useHead({
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(_attrs)} data-v-0e4ef814><div class="narrative" data-v-0e4ef814><h2 data-v-0e4ef814>The story</h2><p data-v-0e4ef814> Rechitta is the communication layer for off-plan real estate in Dubai. A developer launches a project: thousands of brokers to brief, buyers in dozens of languages, prices that move weekly. Rechitta carries the launch as one living briefing \u2014 from the boardroom to every broker&#39;s phone, to every buyer, in their language, grounded in live developer inventory. One launch, thousands of briefings, one source of truth. </p><p data-v-0e4ef814> For developers: control and reach \u2014 your project briefed identically to the entire market, updated live. For brokers: speed \u2014 ask in plain words, match against live inventory, send a briefing that answers back. For buyers: trust \u2014 answers in your language, grounded in the developer&#39;s own data. </p></div>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0e4ef814"]]);

export { index as default };
//# sourceMappingURL=index-hYNfRUgA.mjs.map
