...
export const BEATS: Beat[] = [
  ...
  },
  {
    ...
    clip: 'scene1-3',
    park: 11.0,
    enter: { from: 2.0, to: 11.0, rate: 1.5 },
    hold: 0,
    steps: 4,
  ...
  },
  {
    ...
    clip: 'transit-b',
    park: 16.9,
    enter: { from: 2.0, to: 16.9, rate: 2.5 },
    hold: 1,
    gate: true,
  },
  {
  ...
  })),
  {
    ...
    clip: 'last-scene',
    park: 6.0,
    enter: { from: 0, to: 6.0, rate: 1.2 },
    flash: true,
    progress: FINALE_SPAN.end,
    progressFrom: FINALE_SPAN.start,
  },
];
