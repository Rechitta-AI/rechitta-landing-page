      ...
      */}
      ...
      >
        ...
        */}
        ...
        {/* --- BOTTOM ACTION CONTROLS --- */}
        <div className="buyer-action-reveal flex flex-row flex-wrap sm:flex-row items-center gap-2.5 sm:gap-3 pt-2">
          ...
          <a
            ...
            style={{ fontFamily: 'var(--font-inter)' }}
          >
            <span className="whitespace-nowrap">{stacked ? 'Buyer Platform' : 'Explore Buyer Platform'}</span>
